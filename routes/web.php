...
Route::post('save', [UploadImageController::class, 'save'])->name('save')->middleware('CheckLoggedIn');
Route::get('deleteImage/{image_id}', [UploadImageController::class, 'deleteImage'])->name('deleteImage')->middleware('CheckLoggedIn');
